...
public class SharpshooterAbility extends Ability implements IIdleAbility {
    ...
    public Component getName() {
        return Component.translatable("ability.lsb.sharpshooter");
    }

    @Override
    public void execute() {
        // she jumps up, shoots two projectiles then feather falls down
        //can't attack again until she lands
        //the projectiles are her legs so maybe make them hide until she lands
